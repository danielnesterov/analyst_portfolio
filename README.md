...
|-----|-----|-----|-----|-----|
|1|[Анализ конференций TED talk](https://public.tableau.com/app/profile/daniel.nesterov/viz/TEDTalkpresentation/Story1)| You-Tube| Построены дашборды по истории, тематике и авторам выступлений, проанализированы показатели канала в динамике за период 2001-2021| `tableau` |
